...
class RecommendedFeedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommended_feed" do
    assert_difference('RecommendedFeed.count') do
      post recommended_feeds_url, params: { recommended_feed: { category_id: @recommended_feed.category_id, rssurl: @recommended_feed.rssurl, title: @recommended_feed.title } }
    end
  ...
  test "should update recommended_feed" do
    patch recommended_feed_url(@recommended_feed), params: { recommended_feed: { category_id: @recommended_feed.category_id, rssurl: @recommended_feed.rssurl, title: @recommended_feed.title } }
